...
public static void main(String[] args) 
{
	...
	Employee emp= new Employee();
		...
		for (Employee itee : all1) 
		{
			System.out.println("Employee Id="+itee.getEmpId());
			System.out.println("Employee Name="+itee.getEmpName());
			System.out.println("Employee Locatio="+itee.getEmpLocation());
			System.out.println("\n");
