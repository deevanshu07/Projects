...
public class Main {
    ...
    /*    Employee emp=(Employee) session.get(Employee.class, 1);
        ...
        for (Previledge previledge : set) {
			System.out.println(previledge.getName());
		}*/
         
    /*     Previledge emp=(Previledge) session.get(Previledge.class, 1);
         Set<Employee> set=emp.getEmployees();
