...
<label for="test1">All</label></h3> -->
						...
						<div>
							<h3 id="acc-header-2" class="accord">
								<input class="secound_input" type="checkbox" name="level-2"
									id="test2" /> <label for="test2">Source</label><i
						...
						<div>
							<h3 id="acc-header-3" class="accord">
								<input class="first_input" type="checkbox" name="level-3"
									id="test3" /> <label for="test3">Version</label> <i
									class="fa fa-angle-right " aria-hidden="true"></i>
							</h3>
						...
						<div>
							<h3 id="acc-header-4" class="accord">
								<input class="third_input" type="checkbox" name="level-4"
									id="test4" /> <label for="test4">Product</label><i
									class="fa  fa-angle-right " aria-hidden="true"></i>
							</h3>
				...
				<div class="right_panel panelslide_right" id="right_panel_slide">
					...
					<div class="content_header_panel_right">
							...
							<div class="sort_areaN">
								<span><!--Sort By--></span>
								<ul>
									<li id="sc"><a href="createCase.jsp" target="_blank">Create Case</a></li>
								</ul>
							</div>
							<div class="sort_area">
								<span><!--Sort By--></span>
					...
					<div class="panel_area">
						...
						<span class="box-date">Posted on {{doc.post_time | date: 'MM-dd-yyyy' }} </span>
							...
							<p class="meta">
								...
								<span  data-ng-repeat ="x in doc.label">{{x}}{{$last ? '' : ', '}}</span> | --> <b>Rating:</b> {{doc.kudosCount}} |
								<span class="_mb" ng-show='{{doc["[elevated]"]}}'> Ad</span> <b>Views:</b> {{doc.viewsCount}}
							</p>
							<p data-ng-bind-html="highlight | extractContent:doc.id:doc.content">{{doc.content[4]}}</p>
							<!-- <p class="secound_heading">Author: {{doc.author}}</p> -->
